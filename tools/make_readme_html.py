...
ZIP_NAME = "ListeningHistory.zip"
GITHUB_URL = "https://github.com/SimonArnold002/LMS-Listening-History"
# The version badge is read live from install.xml; the rest are static.
STATIC_BADGES = ["LMS 9.0.0+", "Material Skin", "Library + Streaming + Radio"]


def read_version(root):
    """Current plugin version from install.xml (the single source of truth)."""
    try:
        with open(os.path.join(root, "ListeningHistory", "install.xml"), encoding="utf-8") as f:
...
<title>Listening History — LMS Plugin</title>
</head>
<body>
<p>Redirecting to <a href="README.html">the Listening History page</a>…</p>
</body>
</html>
"""
